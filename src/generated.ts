// Generated by @wagmi/cli@1.3.0 on 6/29/2023 at 12:24:01 AM
import {
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link hasherABI}__.
 */
export function useHasherRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof hasherABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof hasherABI, TFunctionName, TSelectData>,
    'abi'
  > = {} as any,
) {
  return useContractRead({ abi: hasherABI, ...config } as UseContractReadConfig<
    typeof hasherABI,
    TFunctionName,
    TSelectData
  >)
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link hasherABI}__ and `functionName` set to `"hash"`.
 */
export function useHasherHash<
...
>(
  ...
  return useContractRead({
    ...
    functionName: 'hash',
    ...config,
  } as UseContractReadConfig<typeof hasherABI, TFunctionName, TSelectData>)
}
...
>(
  config: Omit<
    UseContractReadConfig<typeof rpsABI, TFunctionName, TSelectData>,
    'abi'
  > = {} as any,
) {
  return useContractRead({ abi: rpsABI, ...config } as UseContractReadConfig<
    typeof rpsABI,
    TFunctionName,
    TSelectData
  >)
 ...
 */
export function useRpsWin<
  TFunctionName extends 'win',
  TSelectData = ReadContractResult<typeof rpsABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof rpsABI, TFunctionName, TSelectData>,
  ...
  return useContractRead({
    ...
    functionName: 'win',
    ...config,
  } as UseContractReadConfig<typeof rpsABI, TFunctionName, TSelectData>)
}
 ...
 */
export function useRpsC2<
  TFunctionName extends 'c2',
  TSelectData = ReadContractResult<typeof rpsABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof rpsABI, TFunctionName, TSelectData>,
 ...
 */
export function useRpsJ2<
  TFunctionName extends 'j2',
  TSelectData = ReadContractResult<typeof rpsABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof rpsABI, TFunctionName, TSelectData>,
 ...
 */
export function useRpsJ1<
  TFunctionName extends 'j1',
  TSelectData = ReadContractResult<typeof rpsABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof rpsABI, TFunctionName, TSelectData>,
 ...
 */
export function useRpsWrite<
  TFunctionName extends string,
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof rpsABI, string>['request']['abi'],
        TFunctionName,
        TMode
      >
  ...
  return useContractWrite<typeof rpsABI, TFunctionName, TMode>({
    abi: rpsABI,
    ...config,
  } as any)
}
...
export function useRpsPlay<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof rpsABI, 'play'>['request']['abi'],
        'play',
        TMode
      > & { functionName?: 'play' }
  ...
  return useContractWrite<typeof rpsABI, 'play', TMode>({
    abi: rpsABI,
    functionName: 'play',
    ...config,
  } as any)
...
export function useRpsSolve<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof rpsABI, 'solve'>['request']['abi'],
        'solve',
        TMode
      > & { functionName?: 'solve' }
  ...
  return useContractWrite<typeof rpsABI, 'solve', TMode>({
    abi: rpsABI,
    functionName: 'solve',
    ...config,
  } as any)
...
export function usePrepareRpsWrite<TFunctionName extends string>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof rpsABI, TFunctionName>,
    'abi'
  > = {} as any,
) {
  return usePrepareContractWrite({
    abi: rpsABI,
    ...config,
  } as UsePrepareContractWriteConfig<typeof rpsABI, TFunctionName>)
}
...
export function usePrepareRpsJ2Timeout(
  config: Omit<
    UsePrepareContractWriteConfig<typeof rpsABI, 'j2Timeout'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'j2Timeout',
    ...config,
  } as UsePrepareContractWriteConfig<typeof rpsABI, 'j2Timeout'>)
}
...
export function usePrepareRpsPlay(
  config: Omit<
    UsePrepareContractWriteConfig<typeof rpsABI, 'play'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'play',
    ...config,
  } as UsePrepareContractWriteConfig<typeof rpsABI, 'play'>)
}
...
export function usePrepareRpsSolve(
  config: Omit<
    UsePrepareContractWriteConfig<typeof rpsABI, 'solve'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'solve',
    ...config,
  } as UsePrepareContractWriteConfig<typeof rpsABI, 'solve'>)
}
...
export function usePrepareRpsJ1Timeout(
  config: Omit<
    UsePrepareContractWriteConfig<typeof rpsABI, 'j1Timeout'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'j1Timeout',
    ...config,
  } as UsePrepareContractWriteConfig<typeof rpsABI, 'j1Timeout'>)
}
